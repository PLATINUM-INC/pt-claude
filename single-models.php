            ...
            <div class="col">
                <div class="model_main_info">
                    ...
                    <ul class="model_params_single">
                        <?php if ($age) { ?>
                            <li><strong><?php esc_html_e('Возраст:', 'pt-claude'); ?></strong> <?php echo $age; ?></li><?php
                        } ?>
                        <?php if ($height) { ?>
                            <li><strong><?php esc_html_e('Рост:', 'pt-claude'); ?></strong> <?php echo $height; ?></li><?php
                        } ?>
                        <?php if ($weight) { ?>
                            <li><strong><?php esc_html_e('Вес:', 'pt-claude'); ?></strong> <?php echo $weight; ?></li><?php
                        } ?>
                        <?php if ($bust) { ?>
                            <li><strong><?php esc_html_e('Грудь:', 'pt-claude'); ?></strong> <?php echo $bust; ?></li><?php
                        } ?>
                        <?php if ($hair) { ?>
                            <li><strong><?php esc_html_e('Волосы:', 'pt-claude'); ?></strong> <?php echo esc_html(pt_translate_hair_color($hair)); ?></li><?php
                        } ?>
                    </ul>
